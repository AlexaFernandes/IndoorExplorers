...
#THE CENTRALIZED APPROACH means, 1 instance of DDDQN chooses de actions of all 4 agents at the same time
class DDDQNAgent(object):
    ...
    #Reset environment and return expanded state.
        self.state = np.expand_dims(self.env.reset(), axis=0) #TODO do I need this??
    ...
    #Run one step for given action and return data.
        ...
        observation = np.expand_dims(observation, axis=0) #TODO do I need this??
    ...
    #every cp_interval number of of episodes. The evaluation is rendered if cp_render is true.
        ...
        for e in range(1, num_episodes + 1):
            ...
            while True:
                ...
                #TODO dar reset quando o tempo limite de exploração for atingido 
                    #if tempo excedido: done= True
